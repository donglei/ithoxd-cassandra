module ithox.cassandra;

// 文档http://datastax.github.io/cpp-driver/
enum CASS_VERSION_MAJOR = 2;
enum CASS_VERSION_MINOR = 2;
enum CASS_VERSION_PATCH = 1;
enum CASS_VERSION_SUFFIX = "";

/**
* The size of an IPv4 address
*/
enum CASS_INET_V4_LENGTH = 4;

/**
* The size of an IPv6 address
*/
enum CASS_INET_V6_LENGTH = 16;

/**
* The size of an inet string including a null terminator.
*/
enum CASS_INET_STRING_LENGTH = 46;

/**
* The size of a hexadecimal UUID string including a null terminator.
*/
enum CASS_UUID_STRING_LENGTH = 37;
enum CASS_LOG_MAX_MESSAGE_SIZE = 256;

extern(C){
	alias unsigned = uint;
	enum cass_bool_t { cass_false = 0, cass_true = 1 }
	alias float cass_float_t;
	alias double cass_double_t;

	alias char cass_int8_t;
	alias ubyte cass_uint8_t;

	alias short cass_int16_t;
	alias ushort cass_uint16_t;

	alias int cass_int32_t;
	alias uint cass_uint32_t;


	alias long cass_int64_t;
	alias ulong cass_uint64_t;

	alias cass_uint8_t cass_byte_t;
	alias cass_uint64_t cass_duration_t;
	...
	struct CassMetrics {
	 ...
	 enum CassWriteType {
	  ...
	  enum CassCollectionType {
		 CASS_COLLECTION_TYPE_LIST = CassValueType.CASS_VALUE_TYPE_LIST,
			 CASS_COLLECTION_TYPE_MAP = CassValueType.CASS_VALUE_TYPE_MAP,
			 CASS_COLLECTION_TYPE_SET = CassValueType.CASS_VALUE_TYPE_SET
	 } ;
	  ...
	  enum  CassErrorSource {
	   ...
	   enum CassError {
		  CASS_OK = 0,
			  ...
			  CASS_ERROR_LIB_BAD_PARAMS = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 1), 
		  CASS_ERROR_LIB_NO_STREAMS = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 2), 
		  CASS_ERROR_LIB_UNABLE_TO_INIT = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 3),
		  CASS_ERROR_LIB_MESSAGE_ENCODE = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 4),
		  CASS_ERROR_LIB_HOST_RESOLUTION = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 5), 
		  CASS_ERROR_LIB_UNEXPECTED_RESPONSE = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 6),
		  CASS_ERROR_LIB_REQUEST_QUEUE_FULL = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 7),
		  CASS_ERROR_LIB_NO_AVAILABLE_IO_THREAD = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 8),
		  CASS_ERROR_LIB_WRITE_ERROR = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 9), 
		  CASS_ERROR_LIB_NO_HOSTS_AVAILABLE = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 10), 
		  CASS_ERROR_LIB_INDEX_OUT_OF_BOUNDS = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 11), 
		  CASS_ERROR_LIB_INVALID_ITEM_COUNT = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 12),
		  CASS_ERROR_LIB_INVALID_VALUE_TYPE = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 13), 
		  CASS_ERROR_LIB_REQUEST_TIMED_OUT = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 14), 
		  CASS_ERROR_LIB_UNABLE_TO_SET_KEYSPACE = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 15),
		  CASS_ERROR_LIB_CALLBACK_ALREADY_SET = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 16), 
		  CASS_ERROR_LIB_INVALID_STATEMENT_TYPE = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 17),
		  CASS_ERROR_LIB_NAME_DOES_NOT_EXIST = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 18), 
		  CASS_ERROR_LIB_UNABLE_TO_DETERMINE_PROTOCOL = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 19), 
		  CASS_ERROR_LIB_NULL_VALUE = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 20),
		  CASS_ERROR_LIB_NOT_IMPLEMENTED = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 21), 
		  CASS_ERROR_LIB_UNABLE_TO_CONNECT = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 22),
		  CASS_ERROR_LIB_UNABLE_TO_CLOSE = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 23), 
		  CASS_ERROR_LIB_NO_PAGING_STATE = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 24), 
		  CASS_ERROR_LIB_PARAMETER_UNSET = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 25), 
		  CASS_ERROR_LIB_INVALID_ERROR_RESULT_TYPE = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 26),
		  CASS_ERROR_LIB_INVALID_FUTURE_TYPE = ((CassErrorSource.CASS_ERROR_SOURCE_LIB << 24) | 27), 
		  CASS_ERROR_SERVER_SERVER_ERROR = ((CassErrorSource.CASS_ERROR_SOURCE_SERVER << 24) | 0x0000),
		  CASS_ERROR_SERVER_PROTOCOL_ERROR = ((CassErrorSource.CASS_ERROR_SOURCE_SERVER << 24) | 0x000A),
		  CASS_ERROR_SERVER_BAD_CREDENTIALS = ((CassErrorSource.CASS_ERROR_SOURCE_SERVER << 24) | 0x0100),
		  CASS_ERROR_SERVER_UNAVAILABLE = ((CassErrorSource.CASS_ERROR_SOURCE_SERVER << 24) | 0x1000), 
		  CASS_ERROR_SERVER_OVERLOADED = ((CassErrorSource.CASS_ERROR_SOURCE_SERVER << 24) | 0x1001), 
		  CASS_ERROR_SERVER_IS_BOOTSTRAPPING = ((CassErrorSource.CASS_ERROR_SOURCE_SERVER << 24) | 0x1002), 
		  CASS_ERROR_SERVER_TRUNCATE_ERROR = ((CassErrorSource.CASS_ERROR_SOURCE_SERVER << 24) | 0x1003), 
		  CASS_ERROR_SERVER_WRITE_TIMEOUT = ((CassErrorSource.CASS_ERROR_SOURCE_SERVER << 24) | 0x1100),
		  CASS_ERROR_SERVER_READ_TIMEOUT = ((CassErrorSource.CASS_ERROR_SOURCE_SERVER << 24) | 0x1200),
		  CASS_ERROR_SERVER_READ_FAILURE = ((CassErrorSource.CASS_ERROR_SOURCE_SERVER << 24) | 0x1300), CASS_ERROR_SERVER_FUNCTION_FAILURE = ((CassErrorSource.CASS_ERROR_SOURCE_SERVER << 24) | 0x1400), CASS_ERROR_SERVER_WRITE_FAILURE = ((CassErrorSource.CASS_ERROR_SOURCE_SERVER << 24) | 0x1500), CASS_ERROR_SERVER_SYNTAX_ERROR = ((CassErrorSource.CASS_ERROR_SOURCE_SERVER << 24) | 0x2000), CASS_ERROR_SERVER_UNAUTHORIZED = ((CassErrorSource.CASS_ERROR_SOURCE_SERVER << 24) | 0x2100), CASS_ERROR_SERVER_INVALID_QUERY = ((CassErrorSource.CASS_ERROR_SOURCE_SERVER << 24) | 0x2200), CASS_ERROR_SERVER_CONFIG_ERROR = ((CassErrorSource.CASS_ERROR_SOURCE_SERVER << 24) | 0x2300), CASS_ERROR_SERVER_ALREADY_EXISTS = ((CassErrorSource.CASS_ERROR_SOURCE_SERVER << 24) | 0x2400), CASS_ERROR_SERVER_UNPREPARED = ((CassErrorSource.CASS_ERROR_SOURCE_SERVER << 24) | 0x2500), CASS_ERROR_SSL_INVALID_CERT = ((CassErrorSource.CASS_ERROR_SOURCE_SSL << 24) | 1), CASS_ERROR_SSL_INVALID_PRIVATE_KEY = ((CassErrorSource.CASS_ERROR_SOURCE_SSL << 24) | 2), CASS_ERROR_SSL_NO_PEER_CERT = ((CassErrorSource.CASS_ERROR_SOURCE_SSL << 24) | 3), CASS_ERROR_SSL_INVALID_PEER_CERT = ((CassErrorSource.CASS_ERROR_SOURCE_SSL << 24) | 4), CASS_ERROR_SSL_IDENTITY_MISMATCH = ((CassErrorSource.CASS_ERROR_SOURCE_SSL << 24) | 5), CASS_ERROR_SSL_PROTOCOL_ERROR = ((CassErrorSource.CASS_ERROR_SOURCE_SSL << 24) | 6),
...
cass_date_time_to_epoch(cass_uint32_t date,
 ...
 alias CassLogCallback = void* delegate(const CassLogMessage* message,
						 void* data);

alias CassFutureCallback = void* delegate(CassFuture* future,void* data);
 /**
 * A log message.
 */
  struct CassLogMessage {
	 ...
	 */
	 ...
	 int line; /**< The line in the file where the message was logged */
	  const char* _function; /**< The function where the message was logged */
	 char[CASS_LOG_MAX_MESSAGE_SIZE] message; /**< The message */
 } ;
}